		...
		<table class="form-table">
			<tbody>
				<tr>
					...
					<td><a href="https://platform.openai.com/docs/plugins/bot" target=_blank>More Info</a></td>
				</tr>
				<tr>
					<th>GPTBot</th>
					<td><p>Used by OpenAI to allow ChatGPT to access the web</p></td>
					<td><a href="https://platform.openai.com/docs/gptbot" target=_blank>More Info</a></td>
				</tr>
				<tr>
					<th>Google Extended</th>
					<td><p>Used by Google to power Gemini (formerly known as Bard)</p></td>
					<td><a href="https://developers.google.com/search/docs/crawling-indexing/overview-google-crawlers?hl=en#common-crawlers" target=_blank>More Info</a></td>
				</tr>
				<tr>
					<th>FacebookBot </th>
					<td><p>Used by Meta (Facebook) for their AI</p></td>
					<td><a href="https://developers.facebook.com/docs/sharing/bot" target=_blank>More Info</a></td>
				</tr>
				<tr>
					<th>CommonCrawl</th>
					<td><p>Compiles datasets used to train AI models</p></td>
					<td><a href="https://commoncrawl.org/big-picture/frequently-asked-questions/" target=_blank>More Info</a></td>
				</tr>
				<tr>
					<th>AnthropicAI</th>
					<td><p>Used by Anthropic</p></td>
					<td><a href="https://darkvisitors.com/agents/anthropic-ai" target=_blank>More Info</a></td>
				</tr>
				<tr>
					<th>Bytespider</th>
					<td><p>Used by TikTok for AI training</p></td>
					<td><a href="https://darkvisitors.com/agents/bytespider" target=_blank>More Info</a></td>
				</tr>
				<tr>
					<th>Omgilibot</th>
					<td><p>Used by Omigili to scrape data for AI training</p></td>
					<td><a href="https://webz.io/blog/machine-learning/common-crawl-vs-webz-io-data-which-one-works-best-for-large-language-models/" target=_blank>More Info</a></td>
				</tr>
				<tr>
					<th>Cohere</th>
					<td><p>Used by Cohere to scrape data for AI training</p></td>
					<td><a href="https://darkvisitors.com/agents/cohere-ai" target=_blank>More Info</a></td>
				</tr>
				<tr>
					<th>Diffbot</th>
